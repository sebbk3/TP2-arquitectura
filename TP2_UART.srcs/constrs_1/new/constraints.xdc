...
# Switches
set_property PACKAGE_PIN V17 [get_ports {data}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data}]
set_property PACKAGE_PIN V16 [get_ports {use_parity}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {use_parity}]
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {solution}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {solution}]
